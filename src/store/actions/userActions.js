...
// @request   /newCustomer
// @response  { }
export const creditRegister = (user_id,email) => async (dispatch) => {
  try {
    ...
    const res = await fetch(`/newCustomer`, config)
